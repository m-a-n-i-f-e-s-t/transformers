#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/powerqwen3_moe/modular_powerqwen3_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_powerqwen3_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if past_key_values is not None:
            ...
            key_states, value_states, gate_states, state, sum_of_keys = past_key_values.update_kv(
                key_states, value_states, gate_states, self.layer_idx, cache_kwargs
            )
...
class PowerQwen3MoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        PowerQwen3MoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class PowerQwen3MoeDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: PowerQwen3MoeConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class PowerQwen3MoeRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: PowerQwen3MoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class PowerQwen3MoePreTrainedModel(PreTrainedModel):
    config: PowerQwen3MoeConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["PowerQwen3MoeDecoderLayer"]
    ...
    _can_record_outputs = {
        "router_logits": OutputRecorder(PowerQwen3MoeSparseMoeBlock, index=1),
        "hidden_states": PowerQwen3MoeDecoderLayer,
        "attentions": PowerQwen3MoeAttention,
    }


@auto_docstring
class PowerQwen3MoeModel(PowerQwen3MoePreTrainedModel):
    def __init__(self, config: PowerQwen3MoeConfig):
        ...
        self.layers = nn.ModuleList(
            [PowerQwen3MoeDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
        self.norm = PowerQwen3MoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = PowerQwen3MoeRotaryEmbedding(config=config)
...
@auto_docstring
class PowerQwen3MoeForCausalLM(PowerQwen3MoePreTrainedModel, GenerationMixin):
...
class PowerQwen3MoeForSequenceClassification(GenericForSequenceClassification, PowerQwen3MoePreTrainedModel):
    pass


class PowerQwen3MoeForTokenClassification(GenericForTokenClassification, PowerQwen3MoePreTrainedModel):
    pass


class PowerQwen3MoeForQuestionAnswering(GenericForQuestionAnswering, PowerQwen3MoePreTrainedModel):
